...
export function PaymentSuccess({
  ...
  const interval = plan?.billingInterval === "annually" ? "annually" : "monthly"
      ...
      <div className="relative container mx-auto flex min-h-[calc(100svh-4rem)] max-w-lg flex-col items-center justify-center gap-4 px-4 text-center">
        ...
        >
          ...
          <p className="text-balance text-muted-foreground">
            Nous confirmons votre transaction. Vous pouvez quitter cette page,
      ...
      >
        ...
        <CardContent className="p-5">
          ...
          <div className="mt-5 rounded-xl border bg-secondary/50 p-3 text-xs text-muted-foreground">
            Un reçu a été envoyé à votre adresse e-mail. Vous pouvez modifier ou
            annuler votre abonnement à tout moment depuis vos paramètres.
          </div>
        </CardContent>
      </Card>
